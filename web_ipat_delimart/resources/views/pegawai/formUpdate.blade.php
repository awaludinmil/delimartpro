            ...
            @if(isset($pegawai['kd_pegawai']))
              ...
              <div class="form-group">
                ...
                <div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_pria" value="Pria" {{ old('jenis_kelamin', $pegawai['jenis_kelamin']) == 'Pria' ? 'checked' : '' }}>
                    <label class="form-check-label" for="jenis_kelamin_pria">Pria</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_wanita" value="Wanita" {{ old('jenis_kelamin', $pegawai['jenis_kelamin']) == 'Wanita' ? 'checked' : '' }}>
              ...
              <div class="form-group">
                ...
                <select name="kd_role" id="kd_role" class="custom-select">
                  ...
                  @foreach ($role as $row)
                    <option value="{{ $row['kd_role'] }}" {{ old('kd_role',$pegawai['kd_role']) == $row['kd_role'] ? 'selected' : '' }}>{{ $row['role'] }}</option>
                  @endforeach
                </select>
                @error('kd_role')
                    <div class="text-danger">{{ $message }}</div>
