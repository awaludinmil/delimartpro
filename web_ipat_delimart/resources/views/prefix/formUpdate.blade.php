          ...
          <div class="card-body">
            @if(isset($prefix['kd_prefix']))
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="prefix" name="prefix" value="{{ $prefix['prefix'] }}">
              </div>
              <div class="form-group">
                ...
                <select name="kd_provider" id="kd_provider" class="custom-select">
                  ...
                  @foreach ($provider as $row)
                    <option value="{{ $row['kd_provider'] }}" {{ $prefix['kd_provider'] == $row['kd_provider'] ? 'selected' : '' }}>{{ $row['provider'] }}</option>
                  @endforeach
                </select>
              </div>
            @else
