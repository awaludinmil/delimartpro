...
class ApiService {
  final String baseUrl =
      'https://praktikum-cpanel-unbin.com/golang_api/delimart_api/';
  ...
  Future<List<LaporanPenerimaanBulanan>?> fetchFromServer() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (final item in body) {
        LaporanPenerimaanBulananList.add(
            LaporanPenerimaanBulanan.fromJson(item));
      }
...
class LaporanPenerimaanBulananList extends StatefulWidget {
  @override
  _LaporanPenerimaanBulananListState createState() =>
      _LaporanPenerimaanBulananListState();
}

class _LaporanPenerimaanBulananListState
    extends State<LaporanPenerimaanBulananList> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final LaporanPenerimaanBulanan laporan =
                        snapshot.data![index];
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text('Pengeluaran: ${formatCurrency(laporan.pengeluaran)}'),
                          ],
                        ),
                      ),
                    );
